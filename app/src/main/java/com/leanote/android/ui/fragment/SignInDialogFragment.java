...
public class SignInDialogFragment extends DialogFragment {
    ...
    private LeaTextView mTitleTextView;
    private LeaTextView mDescriptionTextView;
    private LeaTextView mFooterBottomButton;
    private LeaTextView mFooterCenterButton;
    private LeaTextView mFooterTopButton;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mTitleTextView = (LeaTextView) v.findViewById(R.id.nux_dialog_title);
        mDescriptionTextView = (LeaTextView) v.findViewById(R.id.nux_dialog_description);
        mFooterBottomButton = (LeaTextView) v.findViewById(R.id.nux_dialog_left_button);
        mFooterCenterButton = (LeaTextView) v.findViewById(R.id.nux_dialog_center_button);
        mFooterTopButton = (LeaTextView) v.findViewById(R.id.nux_dialog_right_button);
