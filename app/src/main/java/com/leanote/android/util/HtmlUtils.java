...
public class HtmlUtils {
     ...
     */
    public static SpannableStringBuilder fromHtml(String source, LeaImageGetter wpImageGetter) {
        SpannableStringBuilder html;
        try {
            html = (SpannableStringBuilder) Html.fromHtml(source, wpImageGetter, new LeaHtmlTagHandler());
        ...
        for (QuoteSpan span : spans) {
            html.setSpan(new LeaQuoteSpan(), html.getSpanStart(span), html.getSpanEnd(span), html.getSpanFlags(span));
